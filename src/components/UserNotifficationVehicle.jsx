...
import UserVehicleCard from '../Pages/UserVehicleCard';
      ...
      <div className="row">
        {vehicleNotFound ? (
          ...
          <div className="col-md-4 col-sm-6 mb-4">
            <UserVehicleCard vehicle={vehicle} getImageUrl={getImageUrl} index={id} />
          </div>
        ) : (
          <div className="col-12 text-center">
            <Spinner />
...
export default UserNotificationVehicle;
